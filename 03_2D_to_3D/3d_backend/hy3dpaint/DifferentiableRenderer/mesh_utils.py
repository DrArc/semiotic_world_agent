...
try:
    ...
    print("Warning: bpy (Blender Python API) not available. Some mesh conversion features will be disabled.")
    BPY_AVAILABLE = False
    bpy = None
...
def convert_obj_to_glb(
    ...
    if not BPY_AVAILABLE:
        print("Warning: bpy not available, skipping OBJ to GLB conversion")
        return False
